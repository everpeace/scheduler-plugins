...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PreemptionToleration)(nil), (*config.PreemptionToleration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_PreemptionToleration_To_config_PreemptionToleration(a.(*PreemptionToleration), b.(*config.PreemptionToleration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PreemptionToleration)(nil), (*PreemptionToleration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PreemptionToleration_To_v1beta1_PreemptionToleration(a.(*config.PreemptionToleration), b.(*PreemptionToleration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_PreemptionToleration_To_config_PreemptionToleration(in *PreemptionToleration, out *config.PreemptionToleration, s conversion.Scope) error {
	out.MinimumPreemptablePriority = (*int32)(unsafe.Pointer(in.MinimumPreemptablePriority))
	out.TolerationSeconds = (*int64)(unsafe.Pointer(in.TolerationSeconds))
	return nil
}

// Convert_v1beta1_PreemptionToleration_To_config_PreemptionToleration is an autogenerated conversion function.
func Convert_v1beta1_PreemptionToleration_To_config_PreemptionToleration(in *PreemptionToleration, out *config.PreemptionToleration, s conversion.Scope) error {
	return autoConvert_v1beta1_PreemptionToleration_To_config_PreemptionToleration(in, out, s)
}

func autoConvert_config_PreemptionToleration_To_v1beta1_PreemptionToleration(in *config.PreemptionToleration, out *PreemptionToleration, s conversion.Scope) error {
	out.MinimumPreemptablePriority = (*int32)(unsafe.Pointer(in.MinimumPreemptablePriority))
	out.TolerationSeconds = (*int64)(unsafe.Pointer(in.TolerationSeconds))
	return nil
}

// Convert_config_PreemptionToleration_To_v1beta1_PreemptionToleration is an autogenerated conversion function.
func Convert_config_PreemptionToleration_To_v1beta1_PreemptionToleration(in *config.PreemptionToleration, out *PreemptionToleration, s conversion.Scope) error {
	return autoConvert_config_PreemptionToleration_To_v1beta1_PreemptionToleration(in, out, s)
}
