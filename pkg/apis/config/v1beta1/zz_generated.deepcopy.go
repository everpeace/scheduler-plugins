...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreemptionToleration) DeepCopyInto(out *PreemptionToleration) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.MinimumPreemptablePriority != nil {
		in, out := &in.MinimumPreemptablePriority, &out.MinimumPreemptablePriority
		*out = new(int32)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreemptionToleration.
func (in *PreemptionToleration) DeepCopy() *PreemptionToleration {
	if in == nil {
		return nil
	}
	out := new(PreemptionToleration)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *PreemptionToleration) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
